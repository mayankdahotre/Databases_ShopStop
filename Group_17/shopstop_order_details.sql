...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE CASCADE
...
INSERT INTO `order_details` VALUES (1,1,1,2,100.00),(2,2,2,5,200.00);
