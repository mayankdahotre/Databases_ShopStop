...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`shop_id`) ON DELETE SET NULL
...
INSERT INTO `order` VALUES (1,'RS9876543210','AB101','2025-02-28 23:40:22',500.00,'Completed'),(2,'AV8765432109','CD202','2025-02-28 23:40:22',1000.00,'Pending');
