...
CREATE TABLE `employee` (
  ...
  `salary_status` enum('Paid','Pending') NOT NULL DEFAULT 'Pending',
...
INSERT INTO `employee` VALUES (1,'Suresh Kumar','Cashier','7896541230','AB101',15000.00,'Pending'),(2,'Meena Gupta','Manager','7896541231','CD202',25000.00,'Paid');
